...
@section('content')
    ...
    <div class="col-12 border-left custom-form">
        ...
        <div class="col-12 custom-form vh-80">
            ...
            <form id="formRegistroUsuario" class="needs-validation" method="post"
                action="{{ route('usuario.update', $usuario->pk_id_usuario) }}" onsubmit="agregarNuevoUsuario()" novalidate>
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-3">
                        ...
                        <input name="Cedula" type="number" class="form-control" id="document"
                            placeholder="Documento usuario" value="{{ $usuario->pk_id_usuario }}" required>
                    ...
                    <div class="col-4">
                        ...
                        <input name="NombreUsu" type="text" class="form-control" id="firstName"
                            placeholder="Nombre usuario" value="{{ $usuario->usuNombre }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <input name="ApellidoUsu" type="text" class="form-control" id="lastName"
                            placeholder="Apellido usuario" value="{{ $usuario->usuApellido }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-3">
                        ...
                        <input name="EPS" type="text" class="form-control" id="eps" placeholder="Nombre EPS"
                            value="{{ $usuario->usuNombre_eps }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-3">
                        ...
                        <input name="ARL" type="text" class="form-control" id="arl" placeholder="Nombre ARL"
                            value="{{ $usuario->usuNombre_arl }}" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-3">
                        ...
                        <div class="input-group has-validation">
                            <input name="FechaNacimiento" type="date" class="form-control" id="FechaNacimiento"
                                placeholder="Fecha de nacimiento" value="{{ $usuario->usuFecha_nacimiento }}" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="MunicipioUsu" class="form-select" value="{{ $usuario->usuMunicipio }}"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group has-validation">
                            <input name="DireccionUsu" type="text" class="form-control" id="direccion"
                                placeholder="Dirección residencia" value="{{ $usuario->usuDireccion_residencia }}"
                                required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <input name="CorreoUsu" type="email" class="form-control" id="Correo"
                                placeholder="Correo electrónico" value="{{ $usuario->email }}" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <input name="TelefonoUsu" type="number" class="form-control" id="teléfono"
                                placeholder="Número teléfonico" value="{{ $usuario->usuTelefono }}" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <input name="ProfesionUsu" type="text" class="form-control" id="Profesión"
                                placeholder="Nombre profesión" value="{{ $usuario->usuProfesion }}" required>
                            <div class="invalid-feedback">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group has-validation">
                            <input name="ContraseniaUsu" type="password" class="form-control" id="Contraseña"
                                placeholder="Contraseña usuario" value="{{ $usuario->password }}" required>
                            <div class="invalid-feedback">
                ...
                <x-adminlte-button type="submit" label="Actualizar" theme="warning" />
            </form>
        </div>
    </div>
